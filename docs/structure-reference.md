...
Rule for this project: **take the structure and flow from Fresha, the look (fonts, patterns, motion) from Makro (`design-reference.md`) in Dough n Frost's colours, and the content from Dough n Frost.** Every Fresha logo is replaced with the Dough n Frost mark.
...
## 4. Mapped to Dough n Frost

| Fresha | Dough n Frost |
|---|---|
...
| Push notification with Fresha logo | In-app notification banner with the **Dough n Frost logo** |
