...
Rule for this project: **match fonts, patterns and motion exactly; the palette is Dough n Frost's own (see the note above), and the content and screens are the bakery's.**
...
3. **Photos and logos** (hero portrait, team, testimonial logos) are the template's stock assets. Replaced with Dough n Frost's own photos from Instagram (@dough_n_frost), used with Calvin's go-ahead; see `docs/photo-sources.md`.
