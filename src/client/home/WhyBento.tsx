...
const CHIPS = [
  ...
  { label: "Bridal showers", icon: <Gem size={13} />, x: "40%", y: 90, r: -12, fr: 3 },
    ...
    <section ref={ref} className="bento" data-nav-theme="dark" aria-labelledby="bento-title">
      <div className="bento-head">
        ...
        <Reveal as="p" look="focus" delay={0.1} className="bento-sub">
          Birthdays, weddings and everything in between, from one home kitchen in Adenta, with every order tracked from quote to pickup.
        </Reveal>
      </div>
...
function OccasionsCard() {
  ...
  return (
    <div ref={ref} className="bento-card is-steel is-tall">
      <CardHead tag="Occasions" icon={<Layers size={13} />} title="Every occasion" body="One kitchen for birthdays, weddings, christenings, bridal showers and office events." light />
...
function PartyCard() {
  return (
    <div className="bento-card is-steel">
      <CardHead tag="Plan" icon={<Users size={13} />} title="For the whole party" body="Cupcakes, small chops and snack boxes by the tray, alongside the cake." light />
      <div className="group-strip">
        <span className="group-ghost" />
        <div className="group-tile">
          <Photo tone="mist" src="/photos/small-chops.webp" alt="" position="center 45%" sizes="120px" height={70} radius={10} />
          <strong>Snack boxes × 40</strong>
          <span className="t-cap subtle">Office launch</span>
        </div>
        <span className="group-ghost" />
      </div>
    </div>
...
function PaymentsCard() {
  return (
    <div className="bento-card is-white is-tall">
      <CardHead tag="Pay" icon={<Smartphone size={13} />} title="MoMo payments" body="Pay by mobile money or card, always matched to your order. Full payment books your date." />
      <div className="momo-card">
        ...
        <div className="momo-amount">
          <span className="subtle">+</span>GH₵ 770<span className="subtle">.00</span>
        </div>
      </div>
      <div className="receipt-mini">
        <span className="t-mono t-cap">DNFR-2026-0041</span>
...
function TrackingCard() {
  const rows = [
    { name: "Character cake", ref: "DNF-1041", status: "Decorating", tone: "sky" },
    { name: "Cupcakes × 2 boxes", ref: "DNF-1036", status: "Ready", tone: "berry" },
    { name: "Wedding cake, 4 tiers", ref: "DNF-1044", status: "Baking", tone: "sand" },
  ];
  return (
...
function AllergyCard() {
  return (
    <div className="bento-card is-blush">
      <CardHead tag="Protect" icon={<ShieldCheck size={13} />} title="Allergies remembered" body="Tell us once. Allergies stay on your account and print on every order for the kitchen." />
      <div className="alert-card">
        <div className="inline" style={{ gap: 10 }}>
          ...
          <div className="stack">
            ...
            <span className="t-cap subtle">Character cake · DNF-1041</span>
          </div>
        </div>
        <div className="alert-foot">
          <span>Checked by the decorator</span>
