  ...
  return (
    <section className="closing" data-nav-theme="dark" aria-labelledby="closing-title">
      ...
      <Reveal as="p" look="focus" delay={0.1} className="closing-sub">
        Tell us the occasion and the date. We'll handle the sponge, the frosting and the finish.
      </Reveal>
      <Reveal look="focus" delay={0.15}>
        <Cta tone="berry" onClick={() => navigate("/order/new")}>
          Order now
        </Cta>
      </Reveal>
      ...
      <div className="closing-stage">
        <motion.div ref={previewRef} className="closing-preview" style={calm ? undefined : { y, scale, rotateX, transformPerspective: 1400 }}>
          <Photo tone="mist" src="/photos/wedding-gold-roses.webp" alt="Three-tier white and gold wedding cake with red and white roses by Dough n Frost" position="center 40%" sizes="(min-width: 1024px) 960px, 100vw" height="100%" radius={0} />
          <div className="closing-overlay">
            <div className="closing-chip">
              <span className="badge is-berry" style={{ paddingRight: 12 }}>
                <span className="badge-well">
                  <Check size={13} />
                </span>
                Ready for pickup
              </span>
              <span className="t-cap">Cupcakes × 2 · DNF-1036</span>
            </div>
