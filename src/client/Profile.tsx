      ...
      <div className="profile-grid">
        <div className="profile-left">
          ...
          <motion.section className="account-card" style={{ marginTop: 24 }} {...enter(24, 0.05)}>
            ...
            <div className="account-card-actions">
              <Button variant="berry" size="sm" onClick={() => setSheet("create")}>
                Create account
              </Button>
        ...
        <div className="profile-right">
          ...
          <nav className="card list-card" style={{ marginTop: 16 }} aria-label="Help">
            <MenuRow icon={<MessageCircle size={20} strokeWidth={1.6} />} label="Chat with the bakery" href={STUDIO.whatsappBusiness} />
            <MenuRow icon={<InstagramIcon size={20} strokeWidth={1.6} />} label="Instagram" note="@dough_n_frost" href={STUDIO.instagram} />
          ...
          <div className="stack gap-16">
            ...
            <Button
              ...
              onClick={() => {
                ...
                setSheet(null);
                notify("Phone cleared", "Your details and order list are removed from this phone. The bakery still has your orders.");
              }}
            >
              Forget this phone
            </Button>
        ...
        <div className="profile-left">
          ...
          <motion.section className="balance-card" style={{ marginTop: 24 }} {...enter(24, 0.05)}>
            ...
            <div className="inline" style={{ gap: 8, marginTop: 10 }}>
              {owing[0] && (
                <Button variant="berry" size="sm" onClick={() => navigate(`/orders/${owing[0]?.id}`)}>
                  Pay now
                </Button>
              )}
              <span className="inline t-cap" style={{ color: "var(--berry)", gap: 4 }}>
