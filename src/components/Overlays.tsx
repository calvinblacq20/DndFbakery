...
export function SuccessScreen({ open, title, tone = "success", onDone }: SuccessProps) {
  ...
  const blobs =
    tone === "success"
      ? [
          { c: "#ff9ccb", x: "-20%", y: "-10%", s: "70vmax" },
          { c: "#d4c1ff", x: "35%", y: "30%", s: "65vmax" },
          { c: "#bfe3f5", x: "-10%", y: "55%", s: "55vmax" },
        ]
      : [
          { c: "#e9c7a4", x: "-20%", y: "-10%", s: "70vmax" },
          { c: "#d4c1ff", x: "35%", y: "35%", s: "60vmax" },
          { c: "#c7a597", x: "-15%", y: "55%", s: "55vmax" },
        ];
