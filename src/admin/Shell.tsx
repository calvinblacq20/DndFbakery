...
const GROUPS: { label: string; items: NavItem[] }[] = [
  {
    ...
    items: [
      ...
      { to: "/admin/appointments", label: "Pickups & tastings", icon: CalendarDays, count: (a) => a.visitRequests },
    ],
  },
  {
    label: "People",
...
function Sidebar() {
  ...
  return (
    <aside className="adm-side desktop-only" aria-label="Bakery admin">
      <Link to="/admin" className="adm-brand" aria-label={`${STUDIO.name} admin home`}>
        ...
        <span className="adm-brand-text">
          ...
          <span className="t-cap muted">Bakery admin</span>
        </span>
      </Link>
