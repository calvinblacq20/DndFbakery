...
export function Settings() {
  ...
  return (
    <AdminPage title="Settings" status={<>Bakery details, hours, fees and policies. Changes show on the client app too.</>}>
      ...
      <ConfirmSheet
        ...
        body="The bakery details, opening hours, fees and policies go back to the ones the app shipped with. Orders and clients aren't touched."
        confirmLabel="Reset settings"
        onConfirm={() => {
          studio.resetSettings();
          setDefaultsOpen(false);
          notify("Settings reset", "Bakery details, hours, fees and policies are back to the defaults.");
        }}
      />
    </AdminPage>
  );
  ...
  return (
    <EditCard
      ...
      onSave={(e) => {
        ...
        setError(null);
        notify("Bakery details saved", "Receipts, WhatsApp messages and the client app now use them.");
      }}
    >
      {field("name", "Bakery name")}
      {field("phone", "Phone, WhatsApp and MoMo number", "Quotes tell clients to send MoMo to this number.")}
      {field("email", "Email")}
      {field("area", "Area shown to clients", "e.g. Agyemang Avenue, Adenta")}
      {field("address", "Full address on receipts")}
      {field("directions", "How to find the bakery", "Shown with the map on the client app.")}
      ...
      {field("about", "About the bakery", undefined, "textarea")}
    </EditCard>
  );
}
