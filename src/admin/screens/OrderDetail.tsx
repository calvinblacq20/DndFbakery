...
const PLAN_LABEL: Record<DesignPlan, string> = { ours: "We design it", photo: "From the client's picture", consult: "Design session" };
      ...
      <div className="adm-detail">
          ...
          <section className="adm-card" aria-labelledby="progress">
            ...
            <div className="adm-card-body stack gap-16">
              ...
              <dl className="adm-kv-grid is-4">
                ...
                <div>
                  <dt>Handover</dt>
                  <dd>{order.delivery === "delivery" ? `Delivery · ${order.deliveryTown ?? customer?.town ?? ""}` : "Pickup in Adenta"}</dd>
                </div>
                <div>
        ...
        <aside className="adm-detail-aside adm-stack" aria-label="Client">
          ...
          <section className="adm-card" aria-labelledby="kitchen">
            <CardHead id="kitchen" title="For the kitchen" action={<span className="adm-meta">{PLAN_LABEL[order.designPlan]}</span>} />
            <div className="adm-card-body stack gap-12">
              {customer?.dietary && (
          ...
          {visits.length > 0 && (
            <section className="adm-card" aria-labelledby="order-visits">
              <CardHead id="order-visits" title="Pickup and sessions" />
